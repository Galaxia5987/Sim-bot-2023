...
public class SwerveConstants {
    ...
    public static final double[][] MOTION_MAGIC_CONFIGS = {FRONT_LEFT_MOTION_MAGIC_CONFIGS,
            FRONT_RIGHT_MOTION_MAGIC_CONFIGS, REAR_LEFT_MOTION_MAGIC_CONFIGS, REAR_RIGHT_MOTION_MAGIC_CONFIGS};
    ...
    public static final double MAX_ROTATIONAL_VELOCITY = 13.0;

    public static final double VELOCITY_FEEDFORWARD = 0.33031;
