...
import frc.robot.subsystems.intake.IntakeLoggedInputs;
import org.littletonrobotics.junction.Logger;
import utils.math.AngleUtil;
import utils.units.UnitModel;

import static swerve.SwerveConstants.motionMagicConfigs;
...
public class ArmIOReal implements ArmIO {
    ...
    ArmIOReal() {
        ...
        public void setShoulderJointPower(double power) {
            motorControlRequest = new VoltageOut()
            shoulderMainMotor.set(power);
        }
         ...
         * @param angle desired angle. [degrees]
         */
        public void setShoulderJointAngle(double angle, double ffMultiplier, ArmInputsLogged inputs, Slot0Configs slot0Configs, int velocity) {
            ...
            if (shoulderEncoder.isConnected()) {
                ...
                shoulderMainMotor.setControl(new PositionVoltage(angle, , true, shoulderFeedforward*ffMultiplier, 0, true));

            } else {
                shoulderMainMotor.neutralOutput();
            }
            inputs.shoulderSetpoint = angle;
            inputs.shoulderError = error;
        ...
        public double getElbowMotorVelocity() {
            return elbowMainMotor.getVelocity();
        }
        ...
        public void updateInputs(ArmInputsLogged inputs) {
            ...
            inputs.shoulderMotorPower = shoulderMainMotor.getMotorOutputPercent();
            inputs.elbowMotorPower = elbowMainMotor.getMotorOutputPercent();
            ...
            inputs.shoulderOutputVoltage = shoulderMainMotor.getMotorOutputVoltage();
